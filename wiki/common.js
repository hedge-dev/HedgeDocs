...
function makeImagesClickable() {
    ...
    const images = document.querySelectorAll("figure[typeof~='mw:File/Thumb'] a, figure[typeof~='mw:File'] a, figure[typeof~='mw:File/Frame'] a, .hedgedocs-infobox-image a, .gallery .gallerybox .thumb a")
